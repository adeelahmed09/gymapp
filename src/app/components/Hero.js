...
function Hero() {
    return (
        <>
            ...
            <h1 className="sm:text-6xl text-5xl tracking-tighter sm:w-[50vw] w-[80vw] text-center sm:font-bold font-semibold text-[#99D959]">Stronger Every Day. Start Today.</h1>
